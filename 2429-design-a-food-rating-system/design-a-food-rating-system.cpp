...
public:
    ...
    bool operator<(const Food& other) const {
        // If food ratigns are same, sorting on the basis of their name
        if(foodRating == other.foodRating){
            return foodName > other.foodName;
        }

        // Sorting on the basis of the food rating. (Greater rated food will be on top)
